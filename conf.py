...
latex_elements = {
    ...
    'preamble': r'''
        ...
        \fancyfoot[R]{\ifthenelse{\isodd{\value{page}}}{{\tiny EnOS API管理} }{\href{https://www.envisioniot.com}{\tiny Envision digital}}}
    ...
    'maketitle': r'''
        ...
        \begin{titlepage}
            ...
            \fontsize{30pt}{\baselineskip}\selectfont \textbf{API管理}
...
texinfo_documents = [
    (master_doc, 'EnOSDocumentationCenter', 'EnOS API Management',
     author, 'EnOSDocumentationCenter', 'Product documentation about EnOS API Management.',
     'Miscellaneous'),
]
